        ...
        <>
            ...
            >
                ...
                <div className="hidden md:flex items-center gap-8 transition duration-500">
                    ...
                    <Link to="/generate" className="hover:text-pink-600 transition">Generate</Link>
                    {
                        isLoggedIn ? <Link to="/my-generation" className="hover:text-pink-600 transition">My Generation</Link>

                            : <Link to="#" className="hover:text-pink-600 transition">About</Link>
                    }

                    <Link to="#" className="hover:text-pink-600 transition">Contact Us</Link>
                </div>
